...
- **MGT-107 (Phase 4)** — DB table rename + FK column rename + RLS policy recreate + audit-event-value data rewrite + regenerate `database.ts`. Coordinated deploy; highest risk; requires staging rehearsal + rollback drill.
