...
/**
 * Invite accept page — client component at /invites/[token].
 *
 * When the user clicks "Accept invitation", calls the acceptInvite server action
 * which validates the token, email match, and inserts the membership.
 *
 * If the user is not signed in, the middleware redirects to /auth/login first
 * (this page is outside /admin, so we rely on the action's requireUser check).
 */
